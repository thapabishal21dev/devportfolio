  ...
  return (
    <div className=" flex justify-center  text-black dark:text-white">
      <div className=" w-[780px] md:w-[650px] sm:w-full px-4 ">
        <div>
          <h1 className=" animate-slidein [--slidein-delay:1100ms] opacity-0 text-2xl dark:bg-gradient-to-r dark:from-[#00c8ff] dark:to-[#00ff80] bg-gradient-to-r from-cyan-700 to-green-700 inline-block text-transparent  bg-clip-text font-bold">
            Skills
          </h1>
        </div>
        <div className="  flex flex-row flex-wrap gap-4 py-4 ">
          ...
          <Techstack
            ...
            slideClass="animate-slidein [--slidein-delay:3100ms] opacity-0"
          />
          <Techstack
            techName={"Redux"}
            techImg={<SiRedux />}
            ...
            slideClass="animate-slidein [--slidein-delay:3500ms] opacity-0"
          />
          <Techstack
            techName={"Sass"}
            techImg={<SiSass />}
            ...
            slideClass="animate-slidein [--slidein-delay:3900ms] opacity-0"
          />
          <Techstack
            techName={"GitHub"}
            techImg={<SiGithub />}
            ...
            slideClass="animate-slidein [--slidein-delay:4300ms] opacity-0"
          />{" "}
          <Techstack
            techName={"Figma"}
            techImg={<SiFigma />}
            ...
            slideClass="animate-slidein [--slidein-delay:4700ms] opacity-0"
          />
          <Techstack
            techName={"Git"}
            techImg={<SiGit />}
            ...
            slideClass="animate-slidein [--slidein-delay:6100ms] opacity-0"
          />
        </div>
        <div className=" py-5 ">
